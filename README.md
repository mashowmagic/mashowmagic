...
**TH:** ผู้พัฒนา [MaShowBot](http://mashowbot.play-network.io:9000/) — Discord Music Bot ที่ใช้ TypeScript, Discord.js และ Lavalink ที่มีฟีเจอร์ครบครัน
...
> 🎶 A feature-rich Discord Music Bot | Discord Music Bot ที่มีฟีเจอร์ครบครัน

| Feature | Description |
|---|---|
| 🎵 Music Playback | High-quality audio via Lavalink |
| 🎧 Spotify | Full Spotify track/playlist support |
